...
/*
 * Taken from JBoss ldap utility...
 * http://www.java2s.com/Code/Java/JNDI-LDAP/AstaticutilityclassforcommonJNDIoperations.htm
 */
...
public class JNDIUtils {
  ...
  public static void unbind(Context ctx, Name name) throws NamingException {
    ...
    while (--sz > 0) {
      ...
      try {
        ...
        logger.debug("Unable to remove context " + pname + e);
        break;
      }
    }
  }
  ...
  public static void createLinkRef(Context ctx, String fromName, String toName)
    ...
    logger.debug("Bound link " + fromName + " to " + toName);
  }
  ...
  public static void removeLinkRef(Context ctx, String name) throws NamingException {
	logger.debug("Unbinding link " + name);
    ctx.unbind(name);
  }
