package com.bizislife.core.example.moneyRelated;
...
public class MoneyCalculation {
	...
	public static void main(String... aArgs) {
		...
		String[] twoBDecimals = new String[]{"1.5", "2"};
		
		BigDecimal amountOne = new BigDecimal(twoBDecimals[0]);
		BigDecimal amountTwo = new BigDecimal(twoBDecimals[1]);
