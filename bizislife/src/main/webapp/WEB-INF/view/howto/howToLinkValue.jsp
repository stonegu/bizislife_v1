<div class="methodDetail" style="border: 1px solid;">
    ...
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getHref</h4></div>
        <div class="interface" style="padding: 2px 6px;">
    ...
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getRel</h4></div>
        <div class="interface" style="padding: 2px 6px;">
        ...
        <div class="returns" style="padding: 2px 6px;">
            <div><strong>Returns:</strong></div>
            <div style="padding: 2px 6px;">
                Get link's rel value.<br/>
                Rel valule could be one of "alternate, author, bookmark, help, license, next, nofollow, noreferrer, prefetch, prev, search, tag".
            </div>
        </div>
    </div>
    
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getTarget</h4></div>
        <div class="interface" style="padding: 2px 6px;">
        ...
        <div class="returns" style="padding: 2px 6px;">
            <div><strong>Returns:</strong></div>
            <div style="padding: 2px 6px;">
                Get links target valule.<br/>
                Target valule could be one of "_blank, _parent, _self, _top, framename".
            </div>
        </div>
    </div>
    
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getLinkValue</h4></div>
        <div class="interface" style="padding: 2px 6px;">
