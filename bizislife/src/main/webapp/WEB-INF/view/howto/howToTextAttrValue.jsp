<div class="methodDetail" style="border: 1px solid;">
    ...
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getMaxLength</h4></div>
        <div class="interface" style="padding: 2px 6px;">
        ...
        <div class="returns" style="padding: 2px 6px;">
            <div><strong>Returns:</strong></div>
            <div style="padding: 2px 6px;">
                Maximum characters numbers can this text have.
            </div>
        </div>
    </div>
    
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getMinLength</h4></div>
        <div class="interface" style="padding: 2px 6px;">
        ...
        <div class="returns" style="padding: 2px 6px;">
            <div><strong>Returns:</strong></div>
            <div style="padding: 2px 6px;">
                Minimum characters numbers can this text have.
            </div>
        </div>
    </div>
