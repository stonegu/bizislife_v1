<div class="methodDetail" style="border: 1px solid;">
    ...
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>attr.getMoney</h4></div>
        <div class="interface" style="padding: 2px 6px;">
    ...
    <h3 style="margin: 3px;">Method Detail For Money</h3>
    
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>money.getAmount</h4></div>
        <div class="interface" style="padding: 2px 6px;">
    ...
    <div class="method" style="border: 1px solid; margin: 3px;">
        <div class="methodHead" style="background-color: #DEE3E9; border-bottom: 1px solid; padding: 2px 4px;"><h4>money.getCurrency</h4></div>
        <div class="interface" style="padding: 2px 6px;">
